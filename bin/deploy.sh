...
CSP="\"content-security-policy\": \"default-src 'self'; connect-src 'self' https://basket.mozilla.org https://analysis-output.telemetry.mozilla.org; font-src 'self' code.cdn.mozilla.net; form-action 'none'; img-src 'self' www.google-analytics.com; object-src 'none'; script-src 'self' www.google-analytics.com; style-src 'self' code.cdn.mozilla.net; report-uri /__cspreport__;\""
